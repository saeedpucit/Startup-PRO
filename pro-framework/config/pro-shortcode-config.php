 ...
 *
 */
$startup_pro_animation_names = startup_pro_get_animations();
$startup_pro_animations      = array();
foreach ($startup_pro_animation_names as $key => $value) {
  $startup_pro_animations[$value] = $value;
}
// Animation
// ------------------------------------------------------------------------------------------
$startup_pro_map_animation          = array(
  'id'                     => 'animation',
  'type'                   => 'select',
  'title'                  => 'Animation',
  'options'                => $startup_pro_animations,
);
$startup_pro_map_animation_delay    = array(
  'id'                     => 'animation_delay',
  'type'                   => 'text',
...
$startup_pro_map_animation_duration = array(
...
// Extras
// ------------------------------------------------------------------------------------------
$startup_pro_map_id                 = array(
  'id'                     => 'id',
  'type'                   => 'text',
  'title'                  => 'ID <em>(Optional)</em>',
);
$startup_pro_map_class              = array(
  'id'                     => 'class',
  'type'                   => 'text',
  'title'                  => 'Class <em>(Optional)</em>',
);
$startup_pro_map_style              = array(
  'id'                     => 'in_style',
  'type'                   => 'text',
  'title'                  => 'Inline Style <em>(Optional)</em>',
);
$startup_pro_map_content            = array(
  'id'                     => 'content',
  'type'                   => 'textarea',
  'title'                  => 'Content',
);
$startup_pro_shortcodes                   = array(
  'helpers'                      => array(
    'title'                      => 'Quick Helpers',
    'shortcodes'                 => array(
      //                         ==========================================
      ...
      // DIVIDER WITH ICON
      //                         ==========================================
      'startup_pro_divider_icon'          => array(
        ...
        'shortcode_atts'         => array(
          ...
          $startup_pro_map_content,
        ),
      ),
      //                         ==========================================
      // ALERT
      //                         ==========================================
      'startup_pro_alert'                 => array(
        'title'                  => 'Alert',
        'shortcode_atts'         => array(
          array(
            'id'                 => 'type',
          ...
          $startup_pro_map_animation,
          $startup_pro_map_animation_delay,
          $startup_pro_map_animation_duration,
          $startup_pro_map_content,
        ),
      ),
      //                         ==========================================
      ...
      //                         ==========================================
      'startup_pro_responsive_image'      => array(
        ...
        'shortcode_atts'         => array(
          ...
          array(
            ...
            'type'               => 'select',
            'title'              => 'Image Size',
            'options'            => array_flip( startup_pro_get_image_sizes( true ) ),
            'default'            => 'full',
          ),
          array(
            'id'                 => 'alignment',
      ...
      // RESPONSIVE VIDEO
      //                         ==========================================
      'startup_pro_responsive_video'      => array(
  ...
  'useful'                       => array(
    ...
    'shortcodes'                 => array(
      ...
      // BUTTON GROUP
      //                         ==========================================
      'startup_pro_button_group'          => array(
        'title'                  => 'Button Group',
        'shortcode_atts'         => array( $startup_pro_map_content ),
      ),
    ),
  ),
  'infographics'                 => array(
    ...
    'shortcodes'                 => array(
      ...
      // PROGRESS BAR GROUP
      //                         ==========================================
      'startup_pro_progress_group'        => array(
      ...
      // PROGRESS ICON
      //                         ==========================================
      'startup_pro_progress_icon'         => array(
        'title'                  => 'Progress Icon',
        'shortcode_atts'         => array(
          array(
            'id'                 => 'icon',
  ...
  'lists'                        => array(
    ...
    'shortcodes'                 => array(
      ...
      // ICON LIST
      //                         ==========================================
      'startup_pro_icon_list'             => array(
        'title'                  => 'Icon List',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_icon_list_item',
      ...
      // CLIENT LIST
      //                         ==========================================
      'startup_pro_clients'               => array(
        'title'                  => 'Clients List',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_client',
        'clone_title'            => 'Add New List Item',
        'shortcode_atts'         => array(
          array(
            'id'                 => 'columns',
      ...
      // TESTIMONIAL SLIDER
      //                         ==========================================
      'startup_pro_testimonials'          => array(
        'title'                  => 'Testimonials',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_testimonial',
      ...
      // FAQ
      //                         ==========================================
      'startup_pro_faq'                   => array(
        'title'                  => 'FAQ',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_faq_block',
...
[vc_toggle title                 ="Question"]Answer[/vc_toggle]'
  ...
  'tables'                       => array(
    ...
    'shortcodes'                 => array(
      ...
      // PRICING TABLE
      //                         ==========================================
      'startup_pro_pricing_table'         => array(
        'title'                  => 'Pricing Table',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_pricing_column',
...
40.7060000|-74.0060000|Route Ltd #2',
      ...
      // CAROUSEL CONTENTS
      //                         ==========================================
      'startup_pro_carousel'              => array(
        'title'                  => 'Carousel Contents',
        'view'                   => 'flexible',
        'clone_id'               => 'startup_pro_carousel_item',
...
new NETBEEFramework_Shortcodes_API( $startup_pro_shortcodes );