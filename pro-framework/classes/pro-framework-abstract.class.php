...
abstract class NETBEEFramework_Abstract {
	 ...
	 *
	 */
	public function startup_pro_add_action( $hook, $function_to_add, $priority = 30, $accepted_args = 1 ) {
	 ...
	 *
	 */
	public function startup_pro_add_filter( $tag, $function_to_add, $priority = 30, $accepted_args = 1 ) {
	 ...
	 *
	 */
	public function startup_pro_remove_filter( $tag, $function_to_remove, $priority = 10 ) {
	 ...
	 *
	 */
	public static function startup_pro_add_element( $field = array(), $value = '', $unique = '' ) {
