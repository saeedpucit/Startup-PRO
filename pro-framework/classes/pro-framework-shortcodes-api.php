 ...
 *
 */
class NETBEEFramework_Shortcodes_API extends NETBEEFramework_Abstract {
	public $args = array();
	public $shortcodes = array();
	public function __construct( $args = array() ) {
		$this->args = apply_filters( 'netbeeframework_shortcodes', $args );
		$this->shortcodes = $this->get_shortcodes();
		$this->startup_pro_add_action( 'media_buttons', 'media_shortcode_button', 99 );
		$this->startup_pro_add_action( 'admin_footer', 'shortcode_dialog', 99 );
		$this->startup_pro_add_action( 'wp_ajax_get-shortcode', 'shortcode_generator', 99 );
	}
	/**
	 *
	...
	public function shortcode_generator() {
		...
		foreach ( $shortcode_atts as $key => $field ) {
			...
			$this->startup_pro_add_element( $field, $field_default, 'shortcode' );
		}
