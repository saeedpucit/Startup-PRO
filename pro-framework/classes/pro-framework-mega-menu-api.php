...
class PROFramework_Mega_Menu_API extends NETBEEFramework_Abstract {
	...
	public function __construct() {
		...
		$this->startup_pro_add_filter( 'wp_nav_menu_args', 'wp_nav_menu_args', 99 );

		$this->startup_pro_add_filter( 'wp_edit_nav_menu_walker', 'wp_edit_nav_menu_walker', 10, 2 );

		$this->startup_pro_add_filter( 'wp_setup_nav_menu_item', 'wp_setup_nav_menu_item', 10, 1 );

		$this->startup_pro_add_action( 'wp_update_nav_menu_item', 'wp_update_nav_menu_item', 10, 3 );

		$this->startup_pro_add_action( 'startup_pro_mega_menu_fields', 'startup_pro_mega_menu_fields', 10, 2 );

		$this->startup_pro_add_action( 'startup_pro_mega_menu_labels', 'startup_pro_mega_menu_labels' );
	...
	public function startup_pro_mega_menu_fields( $item_id, $item ) {
		...
		<div class="field-icon description description-wide">
			...
			$icon = ( ! empty( $item->icon ) ) ? ' class="' . startup_pro_icon_class( $item->icon ) . '"' : '';

			?>

			<div class="startup_pro_field startup_pro_field_icon">
	...
	public function startup_pro_mega_menu_labels() {
