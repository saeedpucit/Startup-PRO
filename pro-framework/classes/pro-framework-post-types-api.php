...
class PROFramework_Post_Types_API extends NETBEEFramework_Abstract {
	public function __construct() {
		$this->startup_pro_add_action( 'init', 'register_portfolio', 0 );
		$this->startup_pro_add_filter( 'manage_edit-portfolio_columns', 'edit_thumbnail_columns' );
		$this->startup_pro_add_filter( 'manage_posts_custom_column', 'manage_thumbnail_columns' );
	}
	/**
	 *
