...
$bg_css = startup_pro_redux_bg_css( $options['background-image-footer-area'] );
...
CSS;
	...
	if ( $startup_pro_options['container-width'] ) {
		echo <<<CSS
	@media (min-width: {$options['container-width']['width']}) {
		.container {
			width:{$startup_pro_options['container-width']['width']};
		}
		.boxed #page {
			width:{$startup_pro_options['container-width']['width']};
		}
...
CSS;
	...
	$output = ob_get_clean();
	$css .= $output;
	return startup_pro_css_compress( $css );
}
/**
 *
 * Page CSS
...
// page title stretch
	$startup_pro_options = startup_pro_get_theme_options();
	$options = $startup_pro_options;
	ob_start();
	if ( $options['select-sticky-menu-font-family'] ) {
echo <<<CSS
		#header-sticky .primary-menu .navbar-nav > li > a {
			color: {$startup_pro_options['select-sticky-menu-font-family']['color']};
			font-family: {$startup_pro_options['select-sticky-menu-font-family']['font-family']};
			font-weight: {$startup_pro_options['select-sticky-menu-font-family']['font-weight']};
			text-transform: {$startup_pro_options['select-sticky-menu-font-family']['text-transform']};
			font-size: {$startup_pro_options['select-sticky-menu-font-family']['font-size']};
			line-height: {$startup_pro_options['select-sticky-menu-font-family']['line-height']};
		}
CSS;
	}
...
CSS;
	...
	.sb-icon-search, a.shopping-cart {
		color: {$startup_pro_options['select-menu-font-family-page']['color']};
	}
CSS;
	} else {
		echo <<<CSS
	#header-sticky {
		background-color: {$startup_pro_options['select-menu-font-family']['color']};
	}
CSS;
	}
	if ( isset($options['sticky-header-bg-color-page']['color']) ) {
			echo <<<CSS
	#header-sticky {
		background-color: {$startup_pro_options['sticky-header-bg-color-page']['color']};
	}
CSS;
	} elseif ( isset($startup_pro_options['sticky-header-bg-color']['rgba']) ) {
		echo <<<CSS
	#header-sticky {
		background-color: {$startup_pro_options['sticky-header-bg-color']['rgba']};
	}
CSS;
	}
	$output = ob_get_clean();
