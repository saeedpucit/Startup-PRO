...
class NETBEEFramework_Sidebars_API extends NETBEEFramework_Abstract {
	...
	public function register_footer_sidebars() {
		...
		$sidebars = isset( $startup_pro_options['footer-widgets'] ) ? $startup_pro_options['footer-widgets'] : array();
		if ( $sidebars ) {
			switch ( $sidebars ) {
				case 5:
					$length = 6;
	...
	public function register_custom_sidebars() {
		$startup_pro_options = startup_pro_get_theme_options();
		$get_custom_sidebars = isset( $startup_pro_options['custom-sidebars'] ) ? $startup_pro_options['custom-sidebars'] : array();
