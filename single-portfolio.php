	...
	<div class="single-portofolio">
		<div class="<?php echo esc_attr( $startup_pro_container ) ?> cont-padding">
			<div class="row">
				...
				<div class="col-md-<?php echo esc_attr( $startup_pro_page_column ); ?>">
					<div class="page-content">
						...
						while( have_posts() ) : the_post();
							the_content();
							do_action( 'startup_pro_portfolio_format_content_after', $post );
							startup_pro_link_pages();
							if ( ( $startup_pro_options['show-comments-portofolio'] ) && ( comments_open() || '0' != get_comments_number() ) ) {
				...
				<?php
				if ( $startup_pro_options['show-previous-next-pagination'] ) {
					// prev and next posts
					$startup_pro_prev = get_previous_post( true, null, 'portfolio-category' );
					$startup_pro_next = get_next_post( true, null, 'portfolio-category' );
					?>
